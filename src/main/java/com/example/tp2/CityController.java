...
public class CityController {
    ...
    public void initialize() {
        ...
        Velo v = new Velo();
        Type city = new Type("Ville", 750);
        v.setOptionActive(city);

        CouleurCadre vert = new CouleurCadre("Vert", 0);
        CouleurCadre jaune = new CouleurCadre("Jaune", 50);
        CouleurCadre rouge = new CouleurCadre("Rouge", 60);
        CouleurCadre orange = new CouleurCadre("Orange", 100);

        Texte perso = new Texte("", 50);
